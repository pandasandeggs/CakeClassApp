...
# Cake Classes: The React app for popular cake Classes

## Project goals:

* create an index displaying all classes
* render each class name and cake picture in a list
* show the class details upon a user's click
* allow users to sort the classes based on the class type and filter the instructors that are seen on TV
